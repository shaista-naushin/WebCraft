/*! grapesjs-blocks-avance - 0.0.32 */
!function (t, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n(require("grapesjs")) : "function" == typeof define && define.amd ? define(["grapesjs"], n) : "object" == typeof exports ? exports["grapesjs-blocks-avance"] = n(require("grapesjs")) : t["grapesjs-blocks-avance"] = n(t.grapesjs)
    ...
    return function (t) {
        ...
        var r = Object.assign || function (t) {
            ...
            return t
        }, o = e(2), s = a(o), d = e(3), i = a(d), b = e(7), c = a(b), l = e(0);
        n.default = s.default.plugins.add("gjs-blocks-avance", function (t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, e = r({
                ...
                btnStyles: l.btnStyle,
                progressBarStyle: l.progressBarStyle
            }, n);
            (0, i.default)(t, e), (0, c.default)(t, e)
        })
    }, function (n, e) {
        n.exports = t
    }, function (t, n, e) {
        ...
        Object.defineProperty(n, "__esModule", {value: !0});
        var r = e(4), o = a(r), s = e(5), d = a(s), i = e(6), b = a(i);
        n.default = function (t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            (0, o.default)(t, n), (0, d.default)(t, n), (0, b.default)(t, n)
        }
    }, function (t, n, e) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.default = function (t) {
            var n = (arguments.length > 1 && void 0 !== arguments[1] && arguments[1], t.DomComponents),
                e = n.getType("default"), a = e.model, r = (e.view, n.getType("video")), o = r.view, s = r.model,
                d = [];
            d.push({type: "text", placeholder: "//url.to.page.com", label: "Source", changeProp: 1, name: "src"});
            var i = function () {
                ...
                defaults: Object.assign({}, a.prototype.defaults, {
                    ...
                    var t = this.getSourceTraits();
                    this.loadTraits(t), this.em.trigger("change:selectedComponent")
                }, getSourceTraits: function () {
                    return d
                }, init: function () {
                    //this.set("attributes", {id: i(), src: "", frameborder: 0, allowfullscreen: !0})
                }
            }, {
                isComponent: function (t) {
                    var n = "";
                    return "IFRAME" === t.tagName && "iframe" === t.className && (n = {type: "iframe"}, n.src = t.src), n
                }
            }), c = o.extend({
                initialize: function (t) {
                    o.prototype.initialize.apply(this, [t]);
                    var n = this.model, e = this.el;
                    this.listenTo(n, "change", function () {
                        e.setAttribute("style", "position: relative; height:0; padding-bottom:56.25%;")
                    })
                }, openModal: function (t) {
                    o.prototype.initialize.apply(this, [b])
                }, renderSource: function () {
                    var t = document.createElement("iframe");
                    return t.src = this.model.get("src") === window.location.href ? "" : this.model.get("src"), t.frameBorder = 0, t.setAttribute("allowfullscreen", !1), this.initVideoEl(t), t.style.position = "absolute", setTimeout(function () {
                        t.parentElement.setAttribute("style", "position: relative; height:0; padding-bottom:56.25%;")
                    }, 10), t
                }
            });
            n.addType("iframe", {model: b, view: c})
        }
    }, function (t, n, e) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0});
        ...
        n.default = function (t) {
            var n = (arguments.length > 1 && void 0 !== arguments[1] && arguments[1], t.DomComponents),
                e = n.getType("link"), r = e.model, o = e.view, s = r.prototype.defaults.traits.slice(0);
            s.push({
                type: "select",
                label: "Type",
                name: "btnStyle",
                changeProp: 1,
                options: [{value: a.btnPrimaryClass, name: "Primary"}, {
                    value: a.btnSuccessClass,
                    name: "Success"
                }, {value: a.btnInfoClass, name: "Info"}, {
                    value: a.btnWarningClass,
                    name: "Warning"
                }, {value: a.btnDangerClass, name: "Danger"}, {value: a.btnDefaultClass, name: "Default"}]
            }), s.push({
                type: "select",
                label: "Size",
                name: "btnSize",
                changeProp: 1,
                options: [{value: "btn-normal", name: "Normal"}, {
                    value: a.btnLgClass,
                    name: "Large"
                }, {value: a.btnSmClass, name: "Medium"}, {value: a.btnXsClass, name: "Small"}]
            });
            var d = r.extend({
                init: function () {
                },
                ...
                isComponent: function (t) {
                    var n = "";
                    return "A" === t.tagName && t.className.includes("btn") && "btn" === t.getAttribute("data-type") && (n = {type: "marketing-button"}), n
                }
            }), i = o.extend({
                init: function () {
                    var t = this.model;
                    this.listenTo(t, "change:btnStyle", this.updateButton), this.listenTo(t, "change:btnSize", this.updateButton), this.updateButton();
                    for (var n = arguments.length, e = Array(n), a = 0; a < n; a++) e[a] = arguments[a];
                    o.prototype.init.apply(this, e)
                }, updateButton: function () {
                    var t = this.model.get("btnStyle"), n = this.model.get("btnSize"), e = "btn " + t + " " + n;
                    this.model.setClass(e);
                    var a = this.el;
                    a.setAttribute("class", e), this.el = a
                }
            });
            n.addType("marketing-button", {model: d, view: i})
        }
    }, function (t, n, e) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0});
        ...
        n.default = function (t) {
            var n = (arguments.length > 1 && void 0 !== arguments[1] && arguments[1], t.DomComponents),
                e = n.getType("default"), r = e.model, o = e.view, s = r.prototype.defaults.traits.slice(0);
            s.push({
                type: "number",
                label: "Value",
                name: "pbValue",
                ...
                name: "pbStyle",
                changeProp: 1,
                options: [{value: a.pbPrimaryClass, name: "Primary"}, {
                    value: a.pbSuccessClass,
                    name: "Success"
                }, {value: a.pbInfoClass, name: "Info"}, {
                    value: a.pbWarningClass,
                    name: "Warning"
                }, {value: a.pbDangerClass, name: "Danger"}]
            }), s.push({
                type: "checkbox",
                label: "Striped",
                name: "pbStriped",
                changeProp: 1
            }), s.push({type: "checkbox", label: "Show %", name: "pbPercent", changeProp: 1}), s.push({
                type: "checkbox",
                label: "Animation",
                name: "pbAnimation",
                changeProp: 1
            ...
            var d = r.extend({
                ...
                isComponent: function (t) {
                    var n = "";
                    return "DIV" === t.tagName && t.className.includes("progress") && (n = {type: "marketing-progress-bar"}), n
                }
            }), i = o.extend({
                init: function () {
                    var t = this.model;
                    this.listenTo(t, "change:pbStyle change:pbStriped change:pbPercent change:pbAnimation change:pbValue", this.updateProgress);
                    for (var n = arguments.length, e = Array(n), a = 0; a < n; a++) e[a] = arguments[a];
                    o.prototype.init.apply(this, e)
                }, updateProgress: function () {
                    if (this.el.innerHTML = "", this.el.appendChild(this.getProgressEle()), this.model.set("pbHtml", this.el.outerHTML), !this.el.className.includes("pg-")) {
                        var t = Date.now();
                        this.el.classList.add("pg-" + t)
                    }
                    var n = this.el.className.split(" ").filter(function (t) {
                        return !t.includes("gjs")
                    });
                    this.model.setClass(n.join(" "))
                }, getProgressEle: function () {
                    var t = this.model.get("pbStyle"), n = !0 === this.model.get("pbStriped") ? a.pbStripedClass : "",
                        e = !0 === this.model.get("pbAnimation") ? a.pbAnimateClass : "", r = this.model.get("pbValue"),
                        o = !0 === this.model.get("pbPercent") ? r + "%" : "",
                        s = "progress-bar " + t + " " + n + " " + e, d = document.createElement("div");
                    return d.setAttribute("role", "progressbar"), d.setAttribute("aria-valuenow", r), d.setAttribute("aria-valuemin", "0"), d.setAttribute("aria-valuemax", "100"), d.setAttribute("style", "width: " + r + "%;"), d.setAttribute("class", s), d.innerHTML = o, d
                }, render: function () {
                    return o.prototype.render.apply(this), this.updateProgress(), this
                }
            });
            n.addType("marketing-progress-bar", {model: d, view: i})
        }
    }, function (t, n, e) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.default = function (t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, e = t.BlockManager,
                a = function (t) {
                    return n.blocks.indexOf(t) >= 0
                };
            a("button") && e.add(n.prefixName + "-button", {
                label: "Button",
                category: n.gridsCategory,
                content: '<a class="btn" data-type="btn">CLICK</a> ' + n.btnStyles,
                attributes: {class: "fa fa-plus-square"}
            }), a("link-block") && e.add(n.prefixName + "-link-block", {
                category: n.avanceCategory,
                label: "Link Block",
            ...
            }), a("quote") && e.add(n.prefixName + "-quote", {
                label: "Quote",
                category: n.avanceCategory,
                attributes: {class: "fa fa-quote-right"},
                content: '<blockquote class="quote">\n        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore ipsum dolor sit\n      </blockquote>'
            }), a("text-basic") && e.add(n.prefixName + "-text-basic", {
                category: n.avanceCategory,
                label: "Text section",
                attributes: {class: "gjs-fonts gjs-f-h1p"},
                content: '<section class="bdg-sect">\n      <h1 class="heading">Insert title here</h1>\n      <p class="paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>\n      </section>'
            }), a("iframe") && e.add(n.prefixName + "-iframe", {
            ...
            }), a("footer") && e.add(n.prefixName + "-footer", {
            ...
            var r = 'style="border-collapse: collapse;border-spacing: 0;width: 100%;"',
            ...
            a("grid-items") && e.add(n.prefixName + "-grid-items", {
                label: "Grid Items",
                category: n.gridsCategory,
                content: '<div style="overflow-x:auto;"><table class="grid-item-row" ' + r + '>\n        <tr>\n          <td class="grid-item-cell2-l">' + o + '</td>\n          <td class="grid-item-cell2-r">' + o + "</td>\n        </tr>\n      </table>",
            ...
            a("list-items") && e.add(n.prefixName + "-list-items", {
                label: "List Items",
                category: n.gridsCategory,
                content: s + s,
                attributes: {class: "fa fa-th-list"}
            }), a("progress-bar") && e.add(n.prefixName + "-progress-bar", {
                label: "Progress Bar",
                category: n.gridsCategory,
