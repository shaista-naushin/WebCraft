    ...
    <div>
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form action="/popup/create" enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div id="delayBlock" class="form-group">
                        ...
                        <input type="number" min="1" name="delay" id="delay" value="{{old('delay')}}"
                               class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" required name="animation" id="animation">
                            @foreach(\App\Models\Popup::ANIMATION_IN as $animate)
                                <option value="{{$animate['id']}}">{{$animate['label']}}</option>
                            @endforeach
                        </select>
                    </div>
